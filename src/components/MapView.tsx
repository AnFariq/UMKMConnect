...
const kampusDinamika: LatLngTuple = [-7.310820470765489, 112.7821763079304]
  ...
  return (
    <div className="w-full h-[80vh]">
      ...
      >
        ...
        >
          <Popup>
            <strong>Universitas Dinamika</strong><br />
            STIKOM Surabaya<br />
            Jl. Kedung Baruk No. 98<br />
            Surabaya, Jawa Timur
          </Popup>
        </Marker>
        ...
        {umkmList.map((u) => (
          <Marker key={u.id} position={u.position as LatLngTuple}>
            <Popup>
