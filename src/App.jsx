      ...
      <main className="relative z-10 pt-24 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 animate-fade-in">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-indigo-700 to-slate-700 mb-4">
              Jelajahi UMKM di Sekitarmu
            </h1>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Temukan berbagai usaha lokal yang menarik di sekitar Universitas Dinamika
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">Lokasi Strategis</h3>
              <p className="text-sm text-slate-600">UMKM terpilih di sekitar kampus dengan akses mudah</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">Terverifikasi</h3>
              <p className="text-sm text-slate-600">Semua UMKM telah diverifikasi dan terpercaya</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">Update Real-time</h3>
              <p className="text-sm text-slate-600">Informasi UMKM selalu update dan akurat</p>
            </div>
          </div>
        </div>
      </main>
